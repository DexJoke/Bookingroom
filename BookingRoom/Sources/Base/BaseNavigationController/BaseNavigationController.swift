...
//        navigationBar.barTintColor = Color.beige
//        navigationBar.titleTextAttributes = [.foregroundColor : Color.darkBrown, .font: UIFont.boldSystemFont(ofSize: 15)]
        addUnderLine()
    }
...
//        self.underLineView.backgroundColor = Color.naviLine
